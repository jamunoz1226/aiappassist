...
const TIERS = [
  {
    minutes: 2,
    label: 'Quick Impression',
    description: 'A fast gut-check — perfect if you only have a couple of minutes.',
    topics: [
      'Site URL',
  ...
  },
  {
    minutes: 5,
    label: 'Full Review',
    description: 'A well-rounded pass — the sweet spot for most clients.',
    topics: [
      'Everything in the 2-min review',
      'Visual design & brand feel',
      'Navigation & ease of use',
      'Content accuracy & tone',
      'Mobile experience',
  ...
  },
  {
    minutes: 10,
    label: 'Deep Critique',
    description: 'The full picture — great for complex sites or detailed revisions.',
    topics: [
      'Everything in the 5-min review',
      'Competitor comparison',
      'Brand & copy alignment',
      'Integration & feature gaps',
      'SEO & performance feel',
    ...
    <div className="flex flex-col items-center px-4 py-12 max-w-3xl mx-auto w-full">
      ...
      <div className="mb-10 text-center">
        ...
        <p className="text-slate-400 text-base sm:text-lg max-w-md mx-auto animate-fade-up animate-delay-150">
          Pick how much time you have and we&apos;ll ask the right questions to capture your feedback.
        </p>
      </div>
      ...
      <p className="mt-8 text-xs text-slate-600">
        No login required · Your feedback goes directly to the Manticore team
      </p>
    </div>
  )
}
