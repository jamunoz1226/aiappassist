    ...
    <div className="flex flex-col items-center px-4 py-12 max-w-3xl mx-auto w-full min-h-screen">
      ...
      <div className="grid gap-5 w-full sm:grid-cols-2 animate-fade-up animate-delay-300">
        ...
        >
          ...
          <div className="mt-auto flex items-center gap-1 text-sm font-medium text-amber-400 group-hover:text-amber-300 transition-colors">
            Start intake survey <ArrowRight className="w-4 h-4" />
          </div>
        </button>
        ...
        >
          ...
          <div className="mt-auto flex items-center gap-1 text-sm font-medium text-sky-400 group-hover:text-sky-300 transition-colors">
            Start feedback survey <ArrowRight className="w-4 h-4" />
          </div>
        </button>
      </div>

      <p className="mt-10 text-xs text-slate-600">
        No login required · Your answers go directly to the Lumoz Studio.
      </p>
    </div>
  )
}
