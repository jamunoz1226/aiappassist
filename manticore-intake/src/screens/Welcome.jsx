...
export default function Welcome() {
  ...
  return (
    <div className="flex flex-col items-center px-4 py-12 max-w-3xl mx-auto w-full">
      ...
      {/* Brand image strip */}
      <div className="relative w-full mb-8 rounded-2xl overflow-hidden" style={{ maxHeight: '200px' }}>
        <img
      ...
      <div className="grid gap-4 w-full sm:grid-cols-3">
        {TIERS.map((tier) => (
          <button
            ...
            className={`relative flex flex-col text-left p-5 rounded-2xl border bg-slate-900 transition-all duration-200 cursor-pointer group ${tier.accent}`}
          >
            {tier.popular && (
